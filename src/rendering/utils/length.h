#ifndef MUSIC_LYRIC_PLAYER_RENDERING_UTILS_LENGTH_H_
#define MUSIC_LYRIC_PLAYER_RENDERING_UTILS_LENGTH_H_
...
#endif // MUSIC_LYRIC_PLAYER_RENDERING_UTILS_LENGTH_H_
