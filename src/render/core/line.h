#ifndef MUSIC_LYRIC_PLAYER_RENDER_CORE_LINE_H_
#define MUSIC_LYRIC_PLAYER_RENDER_CORE_LINE_H_
...
namespace music_lyric_player::render::core {
	...
	public:
		 ...
		 */
		void rebuild(const ::lyric::Info& info);
...
#endif // MUSIC_LYRIC_PLAYER_RENDER_CORE_LINE_H_
