#ifndef MUSIC_LYRIC_PLAYER_RENDER_UTILS_COLOR_RGB_H_
#define MUSIC_LYRIC_PLAYER_RENDER_UTILS_COLOR_RGB_H_
...
namespace music_lyric_player::render::utils::color::detail {
	...
	inline ::std::optional<SkColor> parseRgb(::std::string_view body) {
		...
		while (true) {
			...
			parts[count++]                 = render::detail::parseNumber(render::detail::trimLength(piece));
...
#endif // MUSIC_LYRIC_PLAYER_RENDER_UTILS_COLOR_RGB_H_
