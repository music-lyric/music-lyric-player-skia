#ifndef MUSIC_LYRIC_PLAYER_RENDERING_COMPONENTS_LINE_NORMAL_MAIN_SYLLABLE_ANIMATION_FLOAT_H_
#define MUSIC_LYRIC_PLAYER_RENDERING_COMPONENTS_LINE_NORMAL_MAIN_SYLLABLE_ANIMATION_FLOAT_H_
...
namespace music_lyric_player::rendering::components::line::normal::main::syllable::animation {
	...
	private:
		...
		::music_lyric_player::rendering::animation::CubicBezier easing{0.25f, 0.1f, 0.25f, 1.0f};
...
#endif // MUSIC_LYRIC_PLAYER_RENDERING_COMPONENTS_LINE_NORMAL_MAIN_SYLLABLE_ANIMATION_FLOAT_H_
