...
#ifndef MUSIC_LYRIC_PLAYER_RENDER_CONFIG_LINE_INTERLUDE_CONFIG_GEN_H_
#define MUSIC_LYRIC_PLAYER_RENDER_CONFIG_LINE_INTERLUDE_CONFIG_GEN_H_

#include <optional>
#include <string>

namespace music_lyric_player::render::config::line::interlude {
	/**
...
#endif // MUSIC_LYRIC_PLAYER_RENDER_CONFIG_LINE_INTERLUDE_CONFIG_GEN_H_
