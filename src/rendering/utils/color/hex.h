#ifndef MUSIC_LYRIC_PLAYER_RENDERING_UTILS_COLOR_HEX_H_
#define MUSIC_LYRIC_PLAYER_RENDERING_UTILS_COLOR_HEX_H_
...
#endif // MUSIC_LYRIC_PLAYER_RENDERING_UTILS_COLOR_HEX_H_
