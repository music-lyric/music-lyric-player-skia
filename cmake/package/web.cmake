...
# The web module no longer has a preset, so the build tree the former web preset described is spelled out here.
...
if(NOT PACKAGE_SKIP_BUILD)
	...
	execute_process(
		COMMAND "${CMAKE_COMMAND}" -S "${_repo_root}" -B "${_cache_dir}" -G "Ninja"
			"-DCMAKE_TOOLCHAIN_FILE=${_toolchain}" "-DCMAKE_BUILD_TYPE=${PACKAGE_CONFIG}"
