...
# The distribution ships Release only, matching the single web preset the project builds.
...
# Build the module through the same presets the project uses, unless it is already built.
if(NOT PACKAGE_SKIP_BUILD)
	message(STATUS "[Package] Configuring...")
	execute_process(
		COMMAND "${CMAKE_COMMAND}" --preset web
	...
	message(STATUS "[Package] Building music_lyric_player_web...")
	execute_process(
		COMMAND "${CMAKE_COMMAND}" --build --preset web-release --target music_lyric_player_web
		WORKING_DIRECTORY "${_repo_root}"
