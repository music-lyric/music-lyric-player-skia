#ifndef MUSIC_LYRIC_PLAYER_RENDERING_COMPONENTS_CONTAINER_CONTAINER_H_
#define MUSIC_LYRIC_PLAYER_RENDERING_COMPONENTS_CONTAINER_CONTAINER_H_
...
#endif // MUSIC_LYRIC_PLAYER_RENDERING_COMPONENTS_CONTAINER_CONTAINER_H_
